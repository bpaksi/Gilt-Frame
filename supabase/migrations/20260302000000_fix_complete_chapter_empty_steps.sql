-- Fix complete_chapter to handle chapters with no steps.
...
BEGIN
  ...
  v_step_count := COALESCE(array_length(p_step_ids, 1), 0);

  -- Loop is skipped entirely when v_step_count = 0
  FOR v_idx IN 1..v_step_count LOOP
